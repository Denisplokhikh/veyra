...
Локальное desktop-приложение для настройки VPN: импортирует `vless://` ссылки или подписку, дает выбрать один сервер, настраивает профиль и генерирует YAML для `mihomo`.
# Главная страница
![](veyra.png)
